...
import { KageLogo } from '@/components/sidebar/kortix-logo';
                                    ...
                                    <div ref={latestMessageRef} className='w-full h-22 rounded'>
                                        <div className="flex flex-col gap-2">
                                            ...
                                            <div className="flex items-center">
                                                ...
                                                <p className='ml-2 text-sm text-muted-foreground'>{agentName || 'Agent X'}</p>
                                            </div>
